        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-gradient-to-b from-white to-gray-50">
          <div className="container px-4 md:px-6">
            <div className="mx-auto max-w-3xl text-center">
              <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl text-primary">Nos tarifs</h1>
              <p className="mt-4 text-gray-500 md:text-xl">
                Des solutions adaptées à vos besoins, quelle que soit la taille de votre entreprise.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="mx-auto max-w-5xl">
              ...
              <div className="flex flex-col items-center justify-center mb-12">
                <div className="flex items-center space-x-2 bg-gray-100 p-2 rounded-full">
                  <span className={`px-4 py-2 rounded-full ${!isYearly ? "bg-white shadow-sm" : ""}`}>Mensuel</span>
                  ...
                  <span className={`px-4 py-2 rounded-full ${isYearly ? "bg-white shadow-sm" : ""}`}>Annuel</span>
                </div>
                {isYearly && (
              ...
              <div className="grid gap-8 md:grid-cols-3">
                <div className="col-span-1 md:col-span-1">{/* Placeholder for future plans */}</div>
                ...
                <div className="col-span-1 md:col-span-1 rounded-xl border bg-white p-6 shadow-lg relative">
                  ...
                  <div className="flex flex-col space-y-2">
                    ...
                    <p className="text-sm text-gray-500">La solution idéale pour les petites entreprises</p>
                  </div>
                  <div className="mt-6">
                    <div className="flex items-baseline">
                      <span className="text-3xl font-bold">${currentPrice}</span>
                      <span className="ml-1 text-sm text-gray-500">/{isYearly ? "mois" : "mois"}</span>
                    </div>
              ...
              <div className="mt-12 text-center">
                <h3 className="text-lg font-semibold">Besoin d'une solution personnalisée?</h3>
            ...
            <div className="mx-auto max-w-3xl text-center">
              ...
              <div className="mt-8 grid gap-6 text-left">
                <div className="rounded-lg border bg-white p-6">
                  <h3 className="text-lg font-semibold">Comment fonctionne la facturation?</h3>
                  <p className="mt-2 text-gray-500">
                    La facturation est basée sur le nombre de professionnels inscrits sur votre compte. Vous pouvez
                    choisir entre un paiement mensuel ou annuel avec une réduction.
                  </p>
                </div>
                <div className="rounded-lg border bg-white p-6">
                  <h3 className="text-lg font-semibold">Puis-je changer de forfait à tout moment?</h3>
                  <p className="mt-2 text-gray-500">
                    Oui, vous pouvez passer à un forfait supérieur à tout moment. Les ajustements de facturation seront
                    calculés au prorata.
                  </p>
                </div>
                <div className="rounded-lg border bg-white p-6">
                  <h3 className="text-lg font-semibold">Y a-t-il une période d'essai?</h3>
                  <p className="mt-2 text-gray-500">
                    Oui, nous offrons une période d'essai gratuite de 14 jours pour tous nos forfaits, sans carte de
                    crédit requise.
                  </p>
                </div>
              </div>
