...
export default function CalendrierDisponibilites() {
  ...
  // État pour le modal de configuration des disponibilités
  ...
  const [availabilitySettings, setAvailabilitySettings] = useState<{
    ...
    1: { enabled: true, morningStart: "08:00", morningEnd: "12:00", afternoonStart: "14:00", afternoonEnd: "20:00" },
    2: { enabled: true, morningStart: "08:00", morningEnd: "12:00", afternoonStart: "14:00", afternoonEnd: "20:00" },
    3: { enabled: true, morningStart: "08:00", morningEnd: "12:00", afternoonStart: "14:00", afternoonEnd: "20:00" },
    4: { enabled: true, morningStart: "08:00", morningEnd: "12:00", afternoonStart: "14:00", afternoonEnd: "20:00" },
    5: { enabled: true, morningStart: "08:00", morningEnd: "12:00", afternoonStart: "14:00", afternoonEnd: "18:00" },
    6: { enabled: false, morningStart: "09:00", morningEnd: "12:00", afternoonStart: "14:00", afternoonEnd: "17:00" },
    7: { enabled: false, morningStart: "09:00", morningEnd: "12:00", afternoonStart: "14:00", afternoonEnd: "17:00" },
  })
  ...
  const isCellAvailable = (day: Date, hour: string) => {
    ...
    // Vérifier si le jour est activé dans les paramètres
    const daySettings = availabilitySettings[dayOfWeek]
    if (!daySettings || !daySettings.enabled) return false

    // Vérifier si l'heure est dans la plage du matin
    const morningStart = Number.parseInt(daySettings.morningStart.split(":")[0])
    const morningEnd = Number.parseInt(daySettings.morningEnd.split(":")[0])

    // Vérifier si l'heure est dans la plage de l'après-midi
    const afternoonStart = Number.parseInt(daySettings.afternoonStart.split(":")[0])
    const afternoonEnd = Number.parseInt(daySettings.afternoonEnd.split(":")[0])

    return (hourNum >= morningStart && hourNum < morningEnd) || (hourNum >= afternoonStart && hourNum < afternoonEnd)
  }
  ...
  const handleSaveAvailabilities = () => {
    // Convertir les paramètres du formulaire en format de disponibilités
    ...
    Object.entries(availabilitySettings).forEach(([dayKey, settings]) => {
      ...
      if (settings.enabled) {
        // Ajouter la disponibilité du matin si les heures sont valides
        ...
        // Ajouter la disponibilité de l'après-midi si les heures sont valides
    ...
    console.log("Nouvelles disponibilités:", newAvailabilities)
  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-50 w-64 transform bg-white shadow-lg transition-transform duration-300 ease-in-out md:sticky md:top-0 md:h-screen md:translate-x-0 ${
                ...
                {showAvailabilityModal && (
                  <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 p-2 sm:p-4 overflow-y-auto">
                    <div className="w-full max-w-4xl rounded-lg bg-white shadow-xl max-h-[90vh] overflow-y-auto">
                      <div className="sticky top-0 bg-white z-10 flex items-center justify-between border-b px-4 sm:px-6 py-3 sm:py-4">
                        <h3 className="text-base sm:text-lg font-medium">Configuration des disponibilités</h3>
                        <button
                          className="rounded-full p-1 text-gray-400 hover:bg-gray-100 hover:text-gray-500"
                      ...
                      <div className="p-4 sm:p-6">
                        <div className="mb-4 text-sm text-gray-500">
                          Configurez vos heures de disponibilité pour chaque jour de la semaine. Les clients ne pourront
                          prendre rendez-vous que pendant ces plages horaires.
                        </div>

                        <div className="space-y-6">
                          {Object.entries(availabilitySettings).map(([dayKey, settings]) => {
                            const dayOfWeek = Number.parseInt(dayKey)
                            const dayNames = [
                              "",
                              "Lundi",
                              ...
                              <div key={dayKey} className="rounded-lg border p-4">
                                <div className="flex items-center justify-between mb-4">
                                  <div className="flex items-center">
                                    ...
                                    <div className="ml-3 text-sm">
                                      <label htmlFor={`day-enabled-${dayKey}`} className="font-medium text-gray-700">
                                        {dayNames[dayOfWeek]}
                                      </label>
                                    </div>
                                  </div>
                                ...
                                {settings.enabled && (
                                  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                    <div className="space-y-4">
                                      <h4 className="font-medium text-sm">Matin</h4>
                                      <div className="grid grid-cols-2 gap-3">
                                        <div>
                                          <Label htmlFor={`morning-start-${dayKey}`} className="text-sm">
                                            Début
                                          </Label>
                                          <Select
                                          ...
                                          >
                                            <SelectTrigger id={`morning-start-${dayKey}`} className="w-full">
                                              <SelectValue placeholder="Heure de début" />
                                            </SelectTrigger>
                                            <SelectContent>
                                              {Array.from({ length: 13 }, (_, i) => {
                                                const hour = i + 7 // Commencer à 7h
                                                return (
                                                  <SelectItem
                                                    key={`morning-start-${hour}`}
                                        ...
                                        <div>
                                          <Label htmlFor={`morning-end-${dayKey}`} className="text-sm">
                                            Fin
                                          </Label>
                                          <Select
                                          ...
                                          >
                                            <SelectTrigger id={`morning-end-${dayKey}`} className="w-full">
                                    ...
                                    <div className="space-y-4">
                                      <h4 className="font-medium text-sm">Après-midi</h4>
                                      <div className="grid grid-cols-2 gap-3">
                                        <div>
                                          <Label htmlFor={`afternoon-start-${dayKey}`} className="text-sm">
                                            Début
                                          </Label>
                                          <Select
                                          ...
                                          >
                                            <SelectTrigger id={`afternoon-start-${dayKey}`} className="w-full">
                                              <SelectValue placeholder="Heure de début" />
                                            </SelectTrigger>
                                            <SelectContent>
                                              {Array.from({ length: 13 }, (_, i) => {
                                                const hour = i + 12 // Commencer à 12h
                                                return (
                                                  <SelectItem
                                                    key={`afternoon-start-${hour}`}
                                                    value={`${hour.toString().padStart(2, "0")}:00`}
                                                  >
                                                    {`${hour.toString().padStart(2, "0")}:00`}
                                                  </SelectItem>
                                        ...
                                        <div>
                                          <Label htmlFor={`afternoon-end-${dayKey}`} className="text-sm">
                                            Fin
                                          </Label>
                                          <Select
                                          ...
                                          >
                                            <SelectTrigger id={`afternoon-end-${dayKey}`} className="w-full">
                                              <SelectValue placeholder="Heure de fin" />
                                            </SelectTrigger>
                                            <SelectContent>
                                              {Array.from({ length: 13 }, (_, i) => {
                        ...
                        <div className="mt-6 flex flex-col sm:flex-row sm:justify-end space-y-2 sm:space-y-0 sm:space-x-4">
                          ...
                          <Button type="button" onClick={handleSaveAvailabilities} className="w-full sm:w-auto">
