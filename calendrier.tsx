                    ...
                    <div className="grid grid-cols-2">
                      ...
                      <div className="border-r">
                        {workingHours.map((hour, index) => (
                          <div
                            key={index}
                            className="border-b py-6 px-2 text-right text-sm text-gray-500"
                          >
                            {hour}
                          </div>
                        ))}
                                ...
                                <TooltipProvider>
                                  <Tooltip>
                                    <TooltipTrigger asChild>
                                      <button
                                        className={`absolute inset-x-1 top-1 bottom-1 flex flex-col items-start rounded p-1 text-left text-xs text-white ${
                          ...
                          <div className="grid grid-cols-7">
                            {calendarDays.map((day, index) => {
                              ...
                              const dayAppointments =
                                adjustedAppointments.filter((appointment) =>
                                  isSameDay(parseISO(appointment.start), day)
                                );

                              // Vérifier si le jour a des disponibilités
                              const hasAvailability = workingHours.some(
                                (hour) => isCellAvailable(day, hour)
                              );
                        ...
                        return (
                          ...
                          >
                            ...
                            <div className="flex-1">
                              {appointment ? (
                                <button
                                  className={`w-full rounded px-3 py-2 text-left text-white ${
                                    appointment.color || "bg-blue-500"
                                  }`}
                                  onClick={(e) => {
                                    e.stopPropagation();
                    ...
                    >
                      ...
                      <div className="mb-4 sm:mb-6">
                        <Label
                          ...
                          className="mb-1.5 sm:mb-2 block text-sm sm:text-base"
                        >
                          Type de service
                        </Label>
                        <Select
                      ...
                      {appointmentType === "dependent" && (
                        <div className="mt-4 sm:mt-6 space-y-4 sm:space-y-6 border-t pt-4 sm:pt-6">
                          ...
                          <div className="grid grid-cols-1 gap-3 sm:gap-4 sm:grid-cols-2">
                            ...
                            <div>
                              <Label className="mb-1 sm:mb-2 block text-sm sm:text-base">
                                Sexe
                              </Label>
                              <RadioGroup
